...
test_case = {
  ...
  'description' : 'You commit a file named `Hello.java` to your repository',
  'points_possible' : 10,
  'points_earned' : 0,
  'test_ran' : False,
  'test_passed' : False,
...
def do_test( test_case, skip_remaining_tests ):
  ...
  print('Looking for "Hello.java" within your repository...')
  test_timeout = False
  # $ test -e Hello.java
  proc_exists = Popen( ["test", "-e", "Hello.java"] )
  ...
  # test returned
    ...
    if ( proc_exists.returncode != 0 ):
      print('No file named "Hello.java" exists in your repository.')
      print('Check that:')
      ...
      print(' - The file has the exact name "Hello.java"')
      
      test_case['feedback'] = 'File "Hello.java" not found in your repository'
      skip_remaining_tests = True
    # File exists
    else:
      print('A file named "Hello.java" was found in your repository.')
  ...
  if ( skip_remaining_tests ):
    print('All following tests will fail without "Hello.java"; skipping remaining tests...')
